...
public class RegistriesHandler {
  ...
  public static String getKeyMap(Registry registry) {
    if (registry.getName() != null && registry.getUrl() != null
        && registry.getUsername() != null) {
      return registry.getName().concat(registry.getUrl())
          .concat(registry.getUsername());
  ...
  public static Registry registryFromInput(String name, String url,
      String username, String password, String note) {
